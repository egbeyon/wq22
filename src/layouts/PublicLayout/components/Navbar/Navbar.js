...
class Navbar extends Component {
  ...
  render() {
    ...
    const dashText = user && user.role !== 'guest' ? 'Dashboard' : 'team'
    return (
      <Fragment>
        <nav
          ...
          <Link className={classes.logoLink} to="/">
            <Typography className={classes.logo} variant="h2">
              {/* <img className={classes.logo} src='../wq-logo2.png' /> */}
              wq22
            </Typography>
          </Link>
          ...
          <div
              ...
              <div className={classes.navContent}>
                <ul
                  ...
                  <li className={classes.innerNavListItem}>
                  {user && (
                    <Link className={classes.innerNavLink} 
                      to={user.role === 'guest' ? `/teamdash/${user._id}`
                      : '/admin/dashboard'}
                      > {dashText} </Link>
                  )}
                  </li>
